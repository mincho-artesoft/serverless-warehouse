...
export class OrdersController {
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'List of orders retrieved successfully' })
  @Get()
  @UseGuards(TokenVerification)
  findAll() {
  ...
  @ApiOperation({
    ...
    description: 'Retrieves a list of orders for a specific user based on the provided ID.',
  })
  @ApiParam({ name: 'id', description: 'ID' })
  @ApiResponse({ status: HttpStatus.OK, description: 'List of user orders retrieved successfully' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'User not found or has no orders' })
  ...
  @ApiOperation({
    ...
    description: 'Retrieves a list of orders for a specific organization based on the provided ID.',
  })
  @ApiParam({ name: 'id', description: 'ID' })
  @ApiResponse({ status: HttpStatus.OK, description: 'List of organization orders retrieved successfully' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Organization not found or has no orders' })
